...
pub const ETH_ALEN: size_t = 6;
pub const ETH_HLEN: size_t = 14;
pub const ETH_ZLEN: size_t = 60;
pub const ETH_DATA_LEN: size_t = 1500;
pub const ETH_FRAME_LEN: size_t = 1514;
pub const ETH_FCS_LEN: size_t = 4;
